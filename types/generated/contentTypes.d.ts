...
export interface ApiCourseChapterEntryCourseChapterEntry
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    course_chapter: Schema.Attribute.Relation<
      'manyToOne',
    ...
    dynamic: Schema.Attribute.DynamicZone<
      ['shared.rich-text', 'shared.media', 'shared.note', 'quiz.quiz']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::course-chapter-entry.course-chapter-entry'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['study', 'code', 'quiz']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'study'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCourseChapterCourseChapter
  ...
  attributes: {
    course_chapter_entries: Schema.Attribute.Relation<
      'oneToMany',
      'api::course-chapter-entry.course-chapter-entry'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    course_chapters: Schema.Attribute.Relation<
      ...
      'api::course-chapter.course-chapter'
    >;
    course_order: Schema.Attribute.Integer &
      Schema.Attribute.Unique &
    ...
    estimateTime: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::course.course'
...
export interface ApiResourceResource extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<['articles', 'videos', 'other']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
